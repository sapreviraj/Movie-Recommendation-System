...
step1: Install Apache spark on Windows/Linux
step2: Navigate to folder to which you have saved the jar file
step3: Run the following command: spark-submit --class com.sundogsoftware.spark.MovieSimilarities MovieSims.jar 98 */
